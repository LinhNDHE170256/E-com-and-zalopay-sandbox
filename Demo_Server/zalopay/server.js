...
app.post('/payment', async (req, res) => {
    ...
    const embed_data = {
        redirecturl: 'http://localhost:3000/cart/CheckOut', // Chuyển hướng về trang Checkout
    };
    ...
    const order = {
        ...
        amount: parseInt(amount, 10), // Chuyển đổi thành số nguyên
...
app.post('/callback', (req, res) => {
    ...
    try {
        ...
        if (reqMac !== mac) {
            ...
            // Chuyển hướng đến trang checkout với query parameter `success=true`
            res.redirect('http://localhost:3000/cart/CheckOut?success=true');
            return;
        }
    } catch (ex) {
